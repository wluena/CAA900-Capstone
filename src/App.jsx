...
import { fetchAuthSession } from 'aws-amplify/auth'; // <--- MUST BE IMPORTED
...
import OrdersDrawer from './features/orders/OrdersDrawer';
import FeaturedCarousel from './features/home/FeaturedCarousel.jsx';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <NavBar 
        ...
        onOpenOrders={fetchOrders} // <--- Triggers the new secure fetch
